            ...
            for epoch in range(pretraining_epochs):
                ...
                while (not train_data_reader.is_finish()):
                    ...
                    for index in range(n_train_batches):
                        ...
                        pretrain_set_x.set_value(
                            numpy.asarray(temp_train_set_x[index * batch_size:(index + 1) * batch_size],
...
def main_function(cfg):
    ...
    if cfg.NORMCMP:
        ...
        if cfg.output_feature_normalisation == 'MVN':
            ...
            min_max_normaliser = math_statis.Statis(feature_dimension=lab_dim,
    ...
    if cfg.CALMCD and cfg.DurationModel:
        ...
        if cfg.remove_silence_using_binary_labels:
            ...
            remover = SilenceRemover(n_cmp=cfg.dur_dim, silence_pattern=cfg.silence_pattern,
