...
if __name__ == "__main__":
    ...
    #     sys.exit(1)
    in_txt_dir = r"I:\data\voice\CarNumLabeled\text"
    out_utt_dir = r"I:\data\voice\CarNumLabeled\utts"
    out_scm_file = r"I:\data\voice\CarNumLabeled\scm_file.scm"
    out_id_file = r"I:\data\voice\CarNumLabeled\scm_id_file.txt"

    if not os.path.exists(out_utt_dir):
        os.makedirs(out_utt_dir)

    if os.path.isdir(in_txt_dir):
